...
sudo mkdir -p $HELM_CHARTS_SOURCE/
sudo mkdir -p /tmp/helm-tmp/

echo $WORKING_DIRECTORY/. /tmp/helm-tmp/
sudo cp -r $WORKING_DIRECTORY/. /tmp/helm-tmp/
sudo cp -r /tmp/helm-tmp/. $HELM_CHARTS_SOURCE/
